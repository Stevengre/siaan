defmodule SymphonyElixirWeb.Presenter do
  ...
  defp running_entry_payload(entry) do
    %{
      ...
      physical_session_id: Map.get(entry, :physical_session_id),
      physical_session_reuse_decision: Map.get(entry, :physical_session_reuse_decision),
      physical_session_fallback_reason: Map.get(entry, :physical_session_fallback_reason),
      siaan_version: Map.get(entry, :siaan_version),
      model: Map.get(entry, :codex_model),
      repo_head_sha: Map.get(entry, :repo_head_sha),
      repo_branch: Map.get(entry, :repo_branch),
  ...
  defp running_issue_payload(running) do
    %{
      ...
      physical_session_id: Map.get(running, :physical_session_id),
      physical_session_reuse_decision: Map.get(running, :physical_session_reuse_decision),
      physical_session_fallback_reason: Map.get(running, :physical_session_fallback_reason),
      siaan_version: Map.get(running, :siaan_version),
      model: Map.get(running, :codex_model),
      repo_head_sha: Map.get(running, :repo_head_sha),
      repo_branch: Map.get(running, :repo_branch),
